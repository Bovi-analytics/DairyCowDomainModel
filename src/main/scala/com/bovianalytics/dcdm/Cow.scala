...
object Cow {
   ...
   * @param animalFarmNumber The animal's number most commonly used on the farm (also called work number), for instance displayed on collar or as a burnmark, can be re-used over time on the farm.
